  ...
  <div style="padding:5px;">
    ...
    <el-form ref="searchform" inline size="small" :model="searchMap">
      ...
      <el-form-item prop="username" label="用户名">
        <el-select v-model="searchMap.username" style="width:150px;" filterable remote allow-create default-first-option clearable placeholder="请输入关键词" :remote-method="getUsernameList" :loading="searchLoading">
          <el-option v-for="item in usernameList" :key="item.id" :label="item.username" :value="item.username" /></el-select>
      </el-form-item>

      <el-form-item prop="password" label="密码">
        <el-select v-model="searchMap.password" style="width:150px;" filterable remote allow-create default-first-option clearable placeholder="请输入关键词" :remote-method="getPasswordList" :loading="searchLoading">
