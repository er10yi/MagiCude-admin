    ...
    <el-form ref="searchform" inline size="small" :model="searchMap">
      ...
      <div class="invoice-list">
        <ul class="invoice-header">
          ...
          <li class="invoice-item">邮箱</li>
          <li class="invoice-item">电话</li>
        ...
        >
          <span slot-scope="{ data }" class="custom-tree-node">
            ...
            <span class="table_info_item">{{ data.email }} </span>
            <span class="table_info_item">{{ data.phone }}</span>
      ...
      <el-dialog title="编辑(可移动当前类别)" :visible.sync="dialogFormVisible" width="50%" center :before-close="cleanCache">
        <el-form label-width="110px">
          ...
          <el-form-item label="邮箱"><el-input v-model="pojo.email" clearable style="width:400px;" /></el-form-item>
...
<script>
import categoryApi from '@/api/categorycomstru'
...
export default {
  ...
  methods: {
    ...
    remove(data) {
      this.$confirm('此操作将永久删除当前类别，子类将上移一级, 是否继续?', '警告', {
    ...
    removeChild(data) {
      this.$confirm('此操作将永久删除当前类别及所有子类, 是否继续?', '警告', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning',
        center: true
