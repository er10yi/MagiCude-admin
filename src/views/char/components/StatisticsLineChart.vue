<template>
  <div style="height:100%;width:100%">
    ...
    <el-row type="flex" class="row-bg el-row-two" justify="space-between">
      <el-col :span="24">
        <div ref="ipDiv" style="height:340px;width:700px" />
      </el-col>
      <el-col :span="24">
        <div ref="portDiv" style="height:340px;width:700px" />
      </el-col>
    </el-row>
    <br>
    <el-row type="flex" class="row-bg el-row-two" justify="space-between">
      <el-col :span="24">
        <div ref="checkresultDiv" style="height:340px;width:700px" />
      </el-col>
      <el-col :span="24">
        <div ref="riskDiv" style="height:340px;width:700px" />
      </el-col>
    </el-row>
    <br><br>
    <el-row type="flex" class="row-bg el-row-two" justify="space-between">
