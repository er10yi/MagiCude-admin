  ...
  <div style="height:100%;width:100%">
    ...
    <el-row type="flex" class="row-bg el-row-two" justify="space-between">
      <el-col :xs="6" :sm="12" :lg="24">
        <div ref="ipDiv" style="height:300px;width:500px" />
      </el-col>
      <el-col :xs="6" :sm="12" :lg="24">
        <div ref="portDiv" style="height:300px;width:500px" />
      </el-col>
    </el-row>
    <br>
    <el-row type="flex" class="row-bg el-row-two" justify="space-between">
      <el-col :xs="6" :sm="12" :lg="24">
        <div ref="checkresultDiv" style="height:300px;width:500px" />
      </el-col>
      <el-col :xs="6" :sm="12" :lg="24">
        <div ref="riskDiv" style="height:300px;width:500px" />
      </el-col>
    </el-row>
    <br><br>
    <el-row type="flex" class="row-bg el-row-two" justify="space-between">
      <el-col :xs="6" :sm="12" :lg="24">
        <div style="height:300px;width:500px"><checkresult-vuln-pie-nest-chart /></div>
      </el-col>
      <el-col :xs="6" :sm="12" :lg="24">
        <div style="height:300px;width:500px"><checkresult-vuln-online-pie-nest-chart /></div>
      </el-col>
    </el-row>
...
import CheckresultVulnPieNestChart from '@/views/char/components/CheckresultVulnPieNestChart'
import CheckresultVulnOnlinePieNestChart from '@/views/char/components/CheckresultVulnOnlinePieNestChart'
